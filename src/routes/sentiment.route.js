...
// 센티멘트 작성
sentimentRouter.post('/write', upload.array('Img_file', 5) , asyncHandler(wrSentiment));

// 센티멘트 수정
sentimentRouter.patch('/rewrite/:sentimentId',upload.array('Img_file', 5) , asyncHandler(rewrSentiment));

// 센티멘트 삭제
sentimentRouter.delete('/delete/:sentimentId', asyncHandler(delSentiment));
