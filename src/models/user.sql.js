...
// 안 읽은 알림 가져오기
export const getUnreadAlarms = "SELECT * FROM alarm WHERE user_id = ? AND read_at = 0 ORDER BY created_at DESC;";

// 읽은 알림 가져오기 (최대 10개)
export const getReadAlarms = "SELECT * FROM alarm WHERE user_id = ? AND read_at = 1 ORDER BY created_at DESC LIMIT 10;";
